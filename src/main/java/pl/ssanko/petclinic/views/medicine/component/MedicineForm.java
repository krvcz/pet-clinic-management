...
public abstract class MedicineForm extends FormLayout {
    ...
    public MedicineForm(Grid<Medicine> medicineGrid, MedicineService medicineService, Medicine medicine) {
        ...
        add(idTextField, nameTextField, manufacturerTextField, registrationNumberTextField, unitTextField,
                priceTextField, compositionTextField, dosageTextField,
    ...
    protected void refreshGrid() {
        medicineGrid.setItems(query ->
                medicineService.getMedicines(PageRequest.of(query.getPage(), query.getPageSize())));
    }
