import{L as a,c as r,h as l,k as u,p as g,l as m,q as f}from"./indexhtml-bbdf1510.js";import{c as v}from"./custom-element-1c6555a1.js";function y(e){var o;const t=[];for(;e&&e.parentNode;){const s=w(e);if(s.nodeId!==-1){if((o=s.element)!=null&&o.tagName.startsWith("FLOW-CONTAINER-"))break;t.push(s)}e=e.parentElement?e.parentElement:e.parentNode.host}return t.reverse()}function w(e){const t=window.Vaadin;if(t&&t.Flow){const{clients:o}=t.Flow,s=Object.keys(o);for(const i of s){const n=o[i];if(n.getNodeId){const c=n.getNodeId(e);if(c>=0)return{nodeId:c,uiId:n.getUIId(),element:e}}}}return{nodeId:-1,uiId:-1,element:void 0}}var k=Object.defineProperty,E=Object.getOwnPropertyDescriptor,C=(e,t,o,s)=>{for(var i=s>1?void 0:s?E(t,o):t,n=e.length-1,c;n>=0;n--)(c=e[n])&&(i=(s?c(t,o,i):c(i))||i);return s&&i&&k(t,o,i),i};let d=class extends a{render(){return l`<div
      tabindex="-1"
